    ...
    TenancyContext tenancy) : ControllerBase
{
    ...
    [
        ...
        new() { Slug = "aadhaarxml-kyc", Name = "Aadhaar XML KYC", Category = "kyc", Description = "Offline Aadhaar XML ZIP upload verification. Charged per verification via KYC credits.", PricingType = "free", BillingFrequency = "one_time", Price = 0m, Currency = "INR", TaxMode = "exclusive", BillingMetric = "digilockerKyc", CreditsPerSuccess = 3, IsActive = true, IsVisible = true, SortOrder = 8 },
        new() { Slug = "gst-kyc", Name = "GST Verification", Category = "kyc", Description = "GST verification via Appyflow. Charged per verification via KYC credits.", PricingType = "free", BillingFrequency = "one_time", Price = 0m, Currency = "INR", TaxMode = "exclusive", BillingMetric = "digilockerKyc", CreditsPerSuccess = 1, IsActive = true, IsVisible = true, SortOrder = 9 }
    ];

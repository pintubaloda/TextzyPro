...
export default function PlatformLedgerReportPage() {
  ...
  const [filters, setFilters] = useState({ service: "all", status: "all", q: "", fromDate: "", toDate: "", take: 300, page: 1, pageSize: 12 });
  ...
  const exportRows = () => {
    downloadCsv("platform-ledger-report.csv", [
      ["Date", "Tenant", "Slug", "API Name", "Service", "Event", "Reference ID", "Customer Ref", "Credits Used", "Amount", "Status", "Description"],
            ...
            <CardContent className="grid gap-4 md:grid-cols-4">
              ...
              <div className="md:col-span-4 flex flex-wrap gap-2">
                ...
                <Button variant="outline" onClick={() => {
                  const reset = { service: "all", status: "all", q: "", fromDate: "", toDate: "", take: 300, page: 1, pageSize: 12 };
                  setFilters(reset);
                  load(reset);
                }}>Reset</Button>
              </div>
